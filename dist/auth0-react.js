(function (global, factory) {
    ...
    A = {
      f: g
        ...
        : function (e, t) {
            ...
            if (Z(e, t)) return p(!h.f.call(e, t), e[t]);
          },
    },
    R = function (e) {
  ...
  var oe,
    ...
    Be = function (e, t) {
      ...
      for (; t.length > r; ) Z(i, (n = t[r++])) && (~ve(o, n) || o.push(n));
      return o;
    },
    Ce = [
      'constructor',
    ...
    Pe = ze('startsWith'),
    Me = !(
      Pe || ((oe = je(String.prototype, 'startsWith')), !oe || oe.writable)
    );
  We(
    { target: 'String', proto: !0, forced: !Me && !Pe },
    {
      startsWith: function (e) {
        var t = String(B(this));
        Ke(e);
        var n = he(De(arguments.length > 1 ? arguments[1] : void 0, t.length)),
          i = String(e);
  ...
  var ft = $e && +$e,
    It = Ye('species'),
    ht = Ye('isConcatSpreadable'),
    pt =
      ft >= 51 ||
      !d(function () {
        var e = [];
        return (e[ht] = !1), e.concat()[0] !== e;
      }),
    yt = (function (e) {
      return (
        ft >= 51 ||
  ...
  We(
    { target: 'Array', proto: !0, forced: !pt || !yt },
    {
      concat: function (e) {
        var t,
          n,
        ...
        for (t = -1, i = arguments.length; t < i; t++)
          if (bt((o = -1 === t ? c : arguments[t]))) {
            if (a + (r = he(o.length)) > 9007199254740991)
        ...
        Z(on, i)
          ? (n.enumerable
              ? (Z(e, jt) && e[jt][i] && (e[jt][i] = !1),
                (n = Rt(n, { enumerable: p(0, !1) })))
              : (Z(e, jt) || tn(e, jt, p(1, {})), (e[jt][i] = !0)),
            gn(e, i, n))
          : tn(e, i, n)
      );
    },
  ...
  if (
    ...
    We(
      ...
      {
        create: function (e, t) {
          return void 0 === t ? Rt(e) : pn(Rt(e), t);
        },
        defineProperty: hn,
        defineProperties: pn,
  ...
  var Tn = { IteratorPrototype: wn, BUGGY_SAFARI_ITERATORS: En },
    ...
    Pn = function (e, t, n, i, r, o, c) {
      !(function (e, t, n) {
        var i = t + ' Iterator';
        (e.prototype = Rt(Nn, { next: p(1, n) })), Nt(e, i, !1), (Yn[i] = Kn);
      })(n, t, i);
      var s,
        a,
        u,
    ...
    { target: 'Array', stat: !0, forced: gi },
    {
      from: function (e) {
        ...
        if (
          ...
          for (n = new a((t = he(s.length))); t > f; f++)
    ...
    Ni = (function (e, t) {
      ...
      return (Ei[e] =
        ...
        !d(function () {
          if (i && !g) return !0;
          var e = { length: -1 };
          i ? Li(e, 1, { enumerable: !0, get: Ti }) : (e[1] = 1),
            n.call(e, r, o);
        }));
  ...
  var Ki = !d(function () {
    ...
    ji = function (e, t, n) {
      ...
      if (g) i = e;
        ...
        if (ri(r)) {
          for (o = 0, c = he(e.length); c > o; o++)
            if ((s = p(e[o])) && s instanceof zi) return s;
          return new zi(!1);
        }
        i = r.call(e);
      }
        ...
        yr._immediateFn(function () {
          ...
          if (null !== n) {
            ...
            try {
              ...
              return void vr(t.promise, e);
            }
            mr(t.promise, i);
          } else (1 === e._state ? mr : vr)(t.promise, e._value);
        }))
      : e._deferreds.push(t);
  }
  function mr(e, t) {
    try {
      ...
      if (t && ('object' == typeof t || 'function' == typeof t)) {
        var n = t.then;
        if (t instanceof yr) return (e._state = 3), (e._value = t), void Br(e);
  ...
  (yr.prototype.catch = function (e) {
    ...
    (yr.all = function (e) {
      return new yr(function (t, n) {
        if (!hr(e)) return n(new TypeError('Promise.all accepts an array'));
        var i = Array.prototype.slice.call(e);
        if (0 === i.length) return t([]);
        var r = i.length;
        function o(e, c) {
    ...
    (yr.race = function (e) {
      return new yr(function (t, n) {
        if (!hr(e)) return n(new TypeError('Promise.race accepts an array'));
  ...
  var uo = ao.get,
    ...
    Io = {
      get: function (e) {
        var t = fo.get(e);
        return t || fo.get('_legacy_' + e);
      },
      save: function (e, t, n) {
        var i = {};
        'https:' === window.location.protocol && (i = { secure: !0 }),
          (i.expires = n.daysUntilExpire),
          lo('_legacy_' + e, JSON.stringify(t), i),
          fo.save(e, t, n);
      },
      remove: function (e) {
        fo.remove(e), fo.remove('_legacy_' + e);
      },
    },
    ho = {
      get: function (e) {
  ...
  var yo,
    ...
    Bo =
      ...
      (mo = !1),
      function (e) {
        return (vo = vo || po(yo, bo, mo)), new Worker(vo, e);
      }),
    Co = {},
    Fo = new Zr(),
    Uo = {
    ...
    Vo = (function () {
      function e(e) {
        ...
        if (
          ...
          (this.cookieStorage = !1 === e.legacySameSiteCookie ? fo : Io),
          (this.sessionCheckExpiryDays = e.sessionCheckExpiryDays || 1),
          'custom' === this.cacheLocation && !e.customCache)
        )
          throw new Error(
            'Cache location custom requires the customCache option'
          );
        if ('custom' === this.cacheLocation) this.cache = new e.customCache();
        else {
          if (!So(this.cacheLocation))
            throw new Error(
        ...
        var r,
          o,
          c = e.useCookiesForTransactions ? this.cookieStorage : ho;
              ...
              return o(this, function (r) {
                switch (r.label) {
                  ...
                  case 1:
                    return [
                      2,
                      (i = r.sent()) && i.decodedToken && i.decodedToken.user,
                    ];
                }
              });
            })
              ...
              return o(this, function (r) {
                switch (r.label) {
                  ...
                  case 1:
                    return [
                      2,
                      (i = r.sent()) && i.decodedToken && i.decodedToken.claims,
                    ];
                }
              });
            })
            ...
            r(this, void 0, void 0, function () {
              ...
              return o(this, function (g) {
                switch (g.label) {
                  ...
                  case 1:
                    if ((a = g.sent())) return [2, a];
                    g.label = 2;
                  case 2:
                    return [
                      4,
                      ((f = function () {
                        return Fo.acquireLock(
                  ...
                  case 3:
                    if (!g.sent()) return [3, 15];
                    g.label = 4;
                  case 4:
                    return g.trys.push([4, , 12, 14]), t ? [3, 6] : [4, s()];
                  case 5:
                    if ((a = g.sent())) return [2, a];
                    g.label = 6;
                  case 6:
                  ...
                  case 12:
                    return [4, Fo.releaseLock('auth0.lock.getTokenSilently')];
                  case 13:
                    return g.sent(), [7];
                  case 14:
                    return [3, 16];
          ...
          return r(this, void 0, void 0, function () {
            ...
            return o(this, function (o) {
              switch (o.label) {
                ...
                case 2:
                  return (
                    o.trys.push([2, 5, , 6]), [4, Qr(l, this.domainUrl, d)]
                  );
                case 3:
          ...
          return r(this, void 0, void 0, function () {
            ...
            return o(this, function (o) {
              switch (o.label) {
                ...
                case 1:
                  return ((t = o.sent()) && t.refresh_token) || this.worker
                    ? [3, 3]
  ...
  var Auth0Provider = function (opts) {
    ...
    var children = opts.children,
      ...
      _b = opts.onRedirectCallback,
      onRedirectCallback = _b === void 0 ? defaultOnRedirectCallback : _b,
    ...
    var client = React.useState(function () {
      return new Vo(toAuth0ClientOptions(clientOpts));
    })[0];
    var _c = React.useReducer(reducer, initialAuthState),
      state = _c[0],
      dispatch = _c[1];
    React.useEffect(
      function () {
    ...
    var userUpdatedAt =
      (_a = state.user) === null || _a === void 0 ? void 0 : _a.updated_at;
